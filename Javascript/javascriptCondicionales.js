...
if (variable==bariable){
    console.log("Somos igualitos")
}

if(variable!==bariable){
    console.log("Este no es mi compa")
}
...
if(negro>black){
    console.log("Soy más grande que black")
}else{
    console.log ("Soy mas grande que negro")
}
...
// tu mismo nombre tienen ingreso libre así como también los que posean un pase vip,mostrar un mensaje de bienvenida. Si posee entrada preguntar si desea utilizarla, en 
